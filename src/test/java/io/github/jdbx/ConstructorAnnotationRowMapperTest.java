...
import io.github.jdbx.mapper.DefaultMapper;
...
public class ConstructorAnnotationRowMapperTest {
    ...
    private static final List<ColumnMapperFactory> DEFAULT_COLUMN_MAPPER_FACTORY = Collections.<ColumnMapperFactory>singletonList(new DefaultMapper.Factory());
    ...
    public static class Mapping {
        public Mapping(@ConstructorAnnotationRowMapper.Column("COL_1") String a, @ConstructorAnnotationRowMapper.Column("COL_2") int b) {
        }
    }
