...
public class BooleanQueriesTest {
    ...
    public static class BoolConf {
        ...
        public BoolConf(@ConstructorAnnotationRowMapper.Column("CONF_KEY") String key,
                        @ConstructorAnnotationRowMapper.Column("CONF_BOOL") boolean confBool, @ConstructorAnnotationRowMapper.Column("CONF_STR") Boolean confStr,
                        @ConstructorAnnotationRowMapper.Column("CONF_INT") boolean confInt) {
            this.key = key;
