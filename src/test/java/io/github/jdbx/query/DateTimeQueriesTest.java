...
public class DateTimeQueriesTest {
    ...
    public static class Conf {
        ...
        public Conf(@ConstructorAnnotationRowMapper.Column("CONF_KEY") String key,
                    @ConstructorAnnotationRowMapper.Column("CONF_VALUE") ZonedDateTime value,
                    @ConstructorAnnotationRowMapper.Column("CONF_VALUE") LocalDate valueLocalDate,
                    @ConstructorAnnotationRowMapper.Column("CONF_VALUE") LocalDateTime valueLocalDateTime) {
            this.key = key;
            this.value = value;
    ...
    public static class ConfInstant {
        ...
        public ConfInstant(@ConstructorAnnotationRowMapper.Column("CONF_KEY") String key,
                           @ConstructorAnnotationRowMapper.Column("CONF_VALUE") Instant value) {
            this.key = key;
            this.value = value;
        }
    }
