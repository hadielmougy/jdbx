...
import io.github.jdbx.QueryFactory.QueryTypeAndQuery;
...
public enum QueryType {
    ...
    EXECUTE {
        ...
        Object apply(QueryTypeAndQuery queryTypeAndQuery, NamedParameterJdbcTemplate jdbc,
                     ...
                     SortedSet<ParameterConverter> parameterConverters) {
            JdbcAction action = actionFromContext(method, queryTypeAndQuery);
            SqlParameterSource parameters = extractParameters(queryTypeAndQuery,method, args, parameterConverters, jdbc);
            switch (action) {
                case QUERY:
    ...
    private static SqlParameterSource extractParameters(QueryTypeAndQuery queryTypeAndQuery, Method m, Object[] args, SortedSet<ParameterConverter> parameterConverters, NamedParameterJdbcTemplate jdbc) {
